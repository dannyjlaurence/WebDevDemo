...
<html lang="en"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <title>Web Dev Facebook Mini</title>
  ...
  <body>
    ...
    <div class="navbar navbar-inverse navbar-fixed-top" role="navigation">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="http://getbootstrap.com/examples/jumbotron/#">Facebook Mini</a>
        </div>
    ...
    <div class="jumbotron">
      <div class="container">
        <h1>Hello, QUEST Web Dev!</h1>
  	<p>Today, we are going to talk about this example Facebook application. We probably need to do more work to actually make it work, but at least it is a starting point.</p>
